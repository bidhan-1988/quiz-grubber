...
const { getCountUserQuestions } = require('./schema/resolvers/postQuestion');
...
const resolvers = {
    Query: {
        ...
        getCountUserQuestions: (parent, args, context, info) => getCountUserQuestions(args),
    },
    Mutation: {
